...
//TODO ADD TO FILTER JOBS MESSAGE WHEN JOBS WERENT PRINTED
...
//
//
//if ((teaching && strcmp(all_jobs_arr[i]->getJobType(), "teaching ") != 0)
//|| (engineering && strcmp(all_jobs_arr[i]->getJobType(), "engineering ") != 0)
//|| (law && strcmp(all_jobs_arr[i]->getJobType(), "law ") != 0)
//|| (medicine && strcmp(all_jobs_arr[i]->getJobType(), "medicine ") != 0)
//|| (research && strcmp(all_jobs_arr[i]->getJobType(), "research ") != 0)
//|| (sales && strcmp(all_jobs_arr[i]->getJobType(), "sales ") != 0)
//|| (restaurants && strcmp(all_jobs_arr[i]->getJobType(), "restaurants ") != 0)
//|| (cleaning && strcmp(all_jobs_arr[i]->getJobType(), "cleaning ") != 0)
//|| (economy && strcmp(all_jobs_arr[i]->getJobType(), "economy ") != 0))
//match_role = true;
//
////print job after filtration
//if (match_location && match_type && match_role )
